...
# /awolve-signum:backlog-comments
...
Each comment shows: author, ISO timestamp, comment id, and body. Use the comment id with `/awolve-signum:delete-backlog-comment` to remove one.
