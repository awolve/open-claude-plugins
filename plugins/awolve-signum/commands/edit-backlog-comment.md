...
# /awolve-signum:edit-backlog-comment
...
- Run `/awolve-signum:backlog-comments <project> #N` first to find the comment id.
...
- The edit is logged with the item's project as the audit scope, so it appears in `/awolve-signum:log` for that project.
