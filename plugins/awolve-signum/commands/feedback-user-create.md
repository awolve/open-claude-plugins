...
# /awolve-signum:feedback-user-create
...
The command prints the new user's id and the next step. A feedback user starts with no key; mint one with `/awolve-signum:feedback-key-create`.
