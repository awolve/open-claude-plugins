...
# /awolve-spec:feedback-user-delete
...
To rotate a key without deleting the user, use `/awolve-spec:feedback-key-create` followed by `/awolve-spec:feedback-key-revoke`.
