...
# /awolve-signum:delete-bug-comment
...
Bug references accept the short numeric form. The comment ID is the UUID shown in brackets by `/awolve-signum:bug-comments`.
...
- Prefer `/awolve-signum:edit-bug-comment` if you want to keep the thread but change the wording.
