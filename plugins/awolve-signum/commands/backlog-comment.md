...
After commenting, mention that comments can be listed with `/awolve-signum:backlog-comments` and removed with `/awolve-signum:delete-backlog-comment`.
